...
@RestController
@RequestMapping("/api/gestaosaude-kafka")
public class GestaosaudeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GestaosaudeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GestaosaudeKafkaResource(KafkaProperties kafkaProperties) {
